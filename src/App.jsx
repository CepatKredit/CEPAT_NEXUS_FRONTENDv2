      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: "/ckfi/manage-city-municipality",
              element: <ManageCityMunicipalities />,
            },
            ...
            { path: "/ckfi/endorsement", element: <Endorsement /> },
            { path: "/ckfi/searches/:userID/:searchValue", element: <WildSearch/> },
            ...
            {
              path: "/ckfi/assessement/credit",
              element: <DataList_AssignToCra />,
            },
            { path: "/ckfi/queue-bucket", element: <DataList_AssignToCra /> },
            {
              path: "/ckfi/for-verification",
              element: <DataList_AssignToCra />,
            },
            { path: "/ckfi/pre-check", element: <DataList_AssignToCra /> },
            { path: "/ckfi/returned/marketing", element: <DataList /> },
            {
              path: "/ckfi/returned/credit-associate",
              element: <DataList_AssignToCra />,
            },
            {
              path: "/ckfi/reassessed/credit-associate",
              element: <DataList_AssignToCra />,
            },
            {
              path: "/ckfi/returned/credit-officer",
              element: <DataList_AssignToCra />,
            },
            {
              path: "/ckfi/reassessed/credit-officer",
              element: <DataList_AssignToCra />,
            },
