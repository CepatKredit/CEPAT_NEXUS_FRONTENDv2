export const ColumnList = (command, apiQuery) => {
  const column_Marketing = [
    ...
    },
    {
      ...
      width: "180px",
      sorter: (a, b) => {
        return a?.OFWDD?.localeCompare(b?.OFWDD);
      },
      align: "center",
    },
    {
    ...
    {
      title: "Additional Co-Borrower",
      dataIndex: "ACB",
      key: "ACB",
      width: "250px",
      sorter: (a, b) => {
        return a?.ACB?.localeCompare(b?.ACB);
      },
      align: "center",
    },
    {
    ...
    },
    {
      ...
      width: "250px",
      sorter: (a, b) => {
        return a?.UB?.localeCompare(b?.UB);
      },
      align: "center",
    },
    {
      title: "Latest Internal Remarks",
      dataIndex: "LIR",
      key: "LIR",
      sorter: (a, b) => {
        return a?.LIR?.localeCompare(b.LIR);
      },
      width: "500px",
      align: "center",
    },
  ...
  const column_Cro = [
    ...
    },
    {
      ...
      key: "LU",
      sorter: (a, b) => {
        return a?.LU?.localeCompare(b.LU);
      },
      width: "200px",
      align: "center",
    },
