...
function CountryDetails({ option }) {
    ...
    const IntSubGroupListQuery = useQuery({
        ...
        queryFn: async () => {
            const result = await GET_LIST('/api/v1/GET/G14ISG')
    ...
    async function SelectedSub(e) {
        ...
        var data = await POST_DATA('/api/v1/POST/P63GIG', dataHolder)
        setData({
            ...getData,
            IntrntionlSubGrp: e,
    ...
    async function onClickAdd() {
        ...
        await axios.post('/addCountry', data)
            .then(result => {
    ...
    async function onClickUpdate() {
        ...
        await axios.post('/api/v1/POST/P65UC', data)
            .then(result => {
                api[result.data.status]({
                    message: result.data.message,
                    description: result.data.description
