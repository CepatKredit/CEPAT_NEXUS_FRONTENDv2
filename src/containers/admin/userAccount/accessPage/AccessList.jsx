...
function AccessList({ DataList }) {
    ...
    const DepartmentListQuery = useQuery({
        ...
        queryFn: async () => {
            const result = await GET_LIST('/GET/G41DL')
    ...
    const RoleListQuery = useQuery({
        queryKey: ['RoleList'],
        queryFn: async () => {
            const result = await GET_LIST(`/GET/G42RL/${GetDeptId()}`)
    ...
    const DefaultAccessListQuery = useQuery({
        ...
        queryFn: async () => {
            ...
            const result = await POST_DATA('/POST/P78GDAL', data)
            return result.list
        },
        enabled: !!DataList.Id
    })
    ...
    const CustomAccessListQuery = useQuery({
        ...
        queryFn: async () => {
            ...
            const result = await POST_DATA('/POST/P79GCAL', data)
            return result.list
        },
        enabled: !!DataList.Id
    })
    ...
    const onClickUpdateRole = useMutation({
        mutationFn: async () => {
            ...
            setEdit('')
            await axios.post('/POST/P80UR', data)
                .then((result) => {
