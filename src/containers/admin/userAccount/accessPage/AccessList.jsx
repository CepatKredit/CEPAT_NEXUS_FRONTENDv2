...
function AccessList({ DataList }) {
    ...
    const DepartmentListQuery = useQuery({
        ...
        queryFn: async () => {
            const result = await GET_LIST('/v1/GET/G41DL')
    ...
    const RoleListQuery = useQuery({
        queryKey: ['RoleList'],
        queryFn: async () => {
            const result = await GET_LIST(`/v1/GET/G42RL/${GetDeptId()}`)
    ...
    const DefaultAccessListQuery = useQuery({
        ...
        queryFn: async () => {
            ...
            const result = await POST_DATA('/v1/POST/P78GDAL', data)
            return result.list
        },
        enabled: !!DataList.Id
    })
    ...
    const CustomAccessListQuery = useQuery({
        ...
        queryFn: async () => {
            ...
            const result = await POST_DATA('/v1/POST/P79GCAL', data)
            return result.list
        },
        enabled: !!DataList.Id
    })
    ...
    const onClickUpdateRole = useMutation({
        mutationFn: async () => {
            ...
            setEdit('')
            await axios.post('/v1/POST/P80UR', data)
                .then((result) => {
