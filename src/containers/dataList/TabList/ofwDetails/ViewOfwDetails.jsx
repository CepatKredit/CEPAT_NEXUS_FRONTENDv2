...
function ViewOfwDetails({ data, User, RelativesCount, receive }) {
    ...
    const addressItems = [
        ...
        User !== 'LC' && { key: '31', label: <span className={`font-semibold ${data.ofwlosMonth && data.ofwlosYear ? 'text-black' : 'text-orange-500'}`}>Length of Stay</span>, children: `${data.ofwlosMonth ? `${data.ofwlosMonth} months` : ''}${data.ofwlosYear ? ` and ${data.ofwlosYear} years` : ''}` },
