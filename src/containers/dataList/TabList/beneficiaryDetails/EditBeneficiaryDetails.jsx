                ...
                <div className='h-[65vh]'>
                    ...
                    <Flex className="w-full  mt-5" justify="center" gap="small" wrap>
                        ...
                        <LabeledInput
                            ...
                            className_label={'font-bold'}
                            label={'Age'}
                            value={calculateAge(data.benbdate)}
                            readOnly={true}  
                            placeHolder='Age'
                            rendered={rendered}
                        />)}
                            ...
                            <div className="mt-5 w-[18.75rem] h-[3.875rem">
                                ...
                                <input
                                    ...
                                    className={`w-full p-2 border rounded-lg border-gray-300 ${
                                        !isEdit && data.benfblink && data.benfblink.startsWith('https://')
                       ...
                       <DatePicker_BDate
                        ...
                        <div className="mt-5 w-[18.75rem] h-[3.875rem">
                            ...
                            <input
                                type="text"
                                className={`w-full p-2 border rounded-lg border-gray-300 ${
                                    !isEdit && data.coborrowfblink && data.coborrowfblink.startsWith('https://')
                                        ? 'text-blue-500 underline'
                                        : 'text-black'
                                }`}
                                placeholder="Facebook Name / Profile"
