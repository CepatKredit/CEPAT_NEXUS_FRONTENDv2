...
function LoanDetails({ data, receive, loancases }) {
    ...
    async function updateData() {
       /* const values = {
            ...
            Branch: parseInt(data.loanBranch),
            DepartureDate: data.loanDateDep,
            ...
            ProcinceId: data.ofwPresProv,
            MunicipalityId: data.ofwPresMunicipality,
            BarangyId: data.ofwPresBarangay,
            Address1: data.ofwPresStreet,
            PerProcinceId: data.ofwPermProv,
            PerMunicipalityId: data.ofwPermMunicipality,
            PerBarangyId: data.ofwPermBarangay,
            PerAddress1: data.ofwPermStreet,
            ValidId: parseInt(data.ofwvalidid),
            ...
            BenFbProfile: data.benFb,
            BenOwnership: 0,
            BenProcinceId: data.benpresprov,
            BenMunicipalityId: data.benpresmunicipality,
            BenBarangyId: data.benpresbarangay,
