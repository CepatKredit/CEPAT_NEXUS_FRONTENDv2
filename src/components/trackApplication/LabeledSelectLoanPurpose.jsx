...
function LabeledSelectLoanPurpose({error_status, label, value, placeHolder, receive, disabled, readOnly, category, className_dmain, className_label, className_dsub }) {
