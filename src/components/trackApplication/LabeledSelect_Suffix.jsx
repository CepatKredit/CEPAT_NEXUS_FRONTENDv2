...
function LabeledSelect_Suffix({ showSearch, required, placeHolder, label, value, receive,disabled, readOnly, className_dmain, className_label, className_dsub }) {
    ...
    const selectedSuffix = suffixOption?.find(suffix => suffix.code === selectedValue)?.description || '';
