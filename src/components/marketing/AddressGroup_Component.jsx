...
*/
  ...
  const getMunicipalityCode = (type, data) => {
    ...
    if (type === "permanent")
      return data.ofwSameAdd
        ? data.ofwPresMunicipality
        : data.ofwPermMunicipality;
    if (type === "beneficiary")
      return data.bensameadd
        ? data.ofwPresMunicipality
        : data.benpresmunicipality;
    if (type === "provincial")
      return data.ofwProvSameAdd
        ? data.ofwPermMunicipality
        : data.ofwprovMunicipality;
    if (type === "coborrow")
      return data.coborrowSameAdd
        ? data.ofwPresMunicipality
    ...
    <>
      {type === "permanent" ? (
        ...
        <div className="mb-[2%] mt-[2%]">
          <Checkbox
            ...
            onClick={() => {
              ...
              if (
                ...
                (data.ofwPermStreet === "" || data.ofwPermBarangay === "")
              ) {
                api["warning"]({
          ...
          >
            <b>
              Please check if the Provincial Address is the same as the
              Permanent Address of OFW.
            </b>
          </Checkbox>
        </div>
      ) : type === "coborrow" ? (
      ...
      >
        ...
        {category === "direct" ? (
          <LabeledTextArea_Street
            ...
            label={
              <>
                Block / Unit / Street <span className="text-red-500">*</span>
              </>
            }
            disabled={disabled}
            className_dmain={className_dmain}
