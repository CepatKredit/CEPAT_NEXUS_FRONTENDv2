...
function LabeledSelect_Relationship({ rendered, showSearch, required, placeHolder, label, value, receive, disabled, readOnly, category, className_dmain, className_label, className_dsub }) {
        ...
        <div className={className_dmain}>
            ...
            <div className={className_dsub}>
                ...
                <ConfigProvider theme={{
                    ...
                    <Select
                        options={relationshipOptions ? relationshipOptions.map((x) => ({
