                            ...
                            <Table
                                ...
                                dataSource={AppDataListQuery.data
                                    ...
                                    .map((x, i) => ({
                                        ...
                                        AA: formatNumberWithCommas(parseFloat(x.approvedAmount).toFixed(2).toString()),
                                        RA: formatNumberWithCommas(parseFloat(x.releasedAmount).toFixed(2).toString())
                                    }))}
                                expandable={{
                                    expandedRowRender: (data) => (<div className='h-[16rem] overflow-y-auto'>
                                        <Tabs
                                            tabPosition="top"
                                            type="card"
                                            size="small"
